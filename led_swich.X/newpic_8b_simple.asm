...
RES_VECT  CODE    0x0000            ; processor reset vector
    BSF	    STATUS,RP0		    ; selecionar o banco 1 da memória RAM
    BCF	    TRISA,0		    ; zera o bit0 do TRISA, configura o bit0 do PORTA como saída
    BCF	    STATUS,RP0		    ; selecionar o banco 0 da memória RAM
...
LOOP
    ...
    GOTO    LOOP		    ; se B_ACIONADO = 1, pula para o LOOP
    ...
    GOTO    ACENDE_LAMPADA	    ; se LAMPADA = 0, pula para ACENDE_LAMAPDA
    BCF	    LAMPADA		    ; LAMPADA = 0
    GOTO    LOOP
    
ACENDE_LAMPADA
    BSF	    LAMPADA		    ;LAMPADA = 0
    GOTO    LOOP
