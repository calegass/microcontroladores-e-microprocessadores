...
INT_VECT  CODE    0x0004    ;vetor de interrupção, define deve estar a 1ª instrução da interrupção
    ...
    MOVLW   .31		    ;W = 31 -> como cada interrupcao acontece a cada 8 ms, se ja passou 31 = 250ms
    MOVWF   CONTADOR
SAI_INTERRUPCAO
...
LACO_PRINCIPAL
    ...
    BTFSC   TROCA_DISPLAY	;testa se já passou 8ms
    CALL    ATUALIZA_DISPLAY	;se já passou 8ms,chama a subrotina ATUALIZA_DISPLAY
